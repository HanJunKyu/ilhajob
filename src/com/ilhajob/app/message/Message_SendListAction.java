...
public class Message_SendListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		int totalCnt = m_dao.getSendMessageCnt();
		...
		req.setAttribute("messageSendList", m_dao.getMessageSendList(session_id, startRow, endRow));
		
		forward.setRedirect(false);
		forward.setPath("/message_box1.jsp");
